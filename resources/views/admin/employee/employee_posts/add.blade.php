...
<script>
    $(document).ready(function () {
        $('#empPostAdd').on('submit', function (e) {
            ...
            if ($('.emp_category_id').val() === '') {
                isValid = false;
                $('.emp_category_id').addClass('is-invalid').after('<div class="invalid-feedback">Please select a Employee Category.</div>');
            } else {
                $('.emp_category_id').removeClass('is-invalid');
            }

...
$(document).ready(function() {
    ...
    $.ajax({
        ...
        success: function(data) {
            $('#myTable tbody').empty(); // Clear previous data
            ...
            data.forEach((item, index) => {
                ...
                switch(item.status) {
                    ...
                    case '0':
                        ...
                        overtimeDisplay = ''; // No OT for absent
                        break;
                    case '2':
                            ...
                            <ul class="list-unstyled hstack gap-1 mb-0">
                                ...
                                <li>
                                    <input class="form-check-input" type="radio"
                                        name="status[${item.id}]"
                                        data-attendance-id="${item.id}" value="0"
                                ...
                                <li>
                                    <input class="form-check-input" type="radio"
                                        ...
                                        data-attendance-id="${item.id}"
                                        data-employee-id="${item.employee_id}"
                                        data-over-time="${item.over_time}" value="2"

...
<table border="0" cellpadding="0" cellspacing="0" id="sheet0" class="sheet0 gridlines">
    <thead>
        <tr class="row0">
            <th colspan="{{ 5 + $monthDate->daysInMonth }}" class="style210" style="text-align: center; font-weight: bold; font-size: 30px; height: 100px;">
    ...
    <tbody>
        ...
        @foreach($employees as $employeeId => $attendances)
            ...
            @endphp
            <tr>
                <td class="style7" style="border:1px solid black; text-align:center;">{{ $loop->iteration }}</td>
                <td class="style3" style="border:1px solid black; text-align:center;">{{ $employee->first_name }} {{ $employee->last_name }}</td>
                <td class="style3" style="border:1px solid black; text-align:center;">{{ $employee->father_name }} {{ $employee->last_name }}</td>
                <td class="style3" style="border:1px solid black; text-align:center;">{{ $employee->getEmployeePost->emp_post ?? ''}}</td>
                <td class="style16" style="border:1px solid black; text-align:center;">{{ $employee->emp_code }}</td>
                @for ($day = 1; $day <= $monthDate->daysInMonth; $day++)
                    @php

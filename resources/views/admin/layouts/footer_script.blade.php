...
<script src="{{ asset('admin_assets/cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.bundle.min.js') }}"
    crossorigin="anonymous"></script>
<script src="{{ asset('admin_assets/js/scripts.js') }}"></script>
<script src="{{ asset('admin_assets/cdn.jsdelivr.net/npm/litepicker/dist/bundle.js') }}" crossorigin="anonymous">
</script>

        ...
        <div class="row">
            <div class="col-xl-12">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="{{ route('category_of_service.update', $categoryOfService->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <!-- Form Row -->
                            <div class="row gx-3 mb-3">
                                ...
                                <div class="col-6 col-md-6">
                                    ...
                                    <input id="productname" name="category_of_service" type="text" class="form-control" value="{{$categoryOfService->category_of_service}}" placeholder="Category Of Service">
                                ...
                                <div class="col-6 col-md-6">
                                    ...
                                    <input id="productname" name="sac_code" type="text" class="form-control" value="{{$categoryOfService->sac_code}}" placeholder="SAC Code">
                                    @if ($errors->has('sac_code'))
                                        <div class="text-danger">{{ $errors->first('sac_code') }}</div>
                                    @endif
                                </div>
                            </div>
                            <button class="btn btn-primary" type="submit">Update Category Of Service</button>
                        </form>
                    </div>
                </div>
            </div>

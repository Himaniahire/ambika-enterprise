...
<body>
    <div class="container">
        <table class="header" style="border: 3px solid #000; width: 70%;">
            <tr class="text-red">
                <th colspan="7" style="width: 100%; text-align: center;width:70px;">TAX-INVOICE</th>
            </tr>
            <tr class="text-red">
                <th colspan="7" style="width: 100%; text-align: center;width:70px; border-right: 1px solid #000; border-left: 1px solid #000;border-top: 1px solid #000;"><b>AMBIKA ENTERPRISE</b></th>
            </tr>
            <tr class="p-tag">
            ...
            <tr>
                ...
                <th class="bt" colspan="2" rowspan="2" style="text-align: center; border-right: 1px solid #000; border-bottom: 1px solid #000">
                    <div class="text-center" >
                        <p class="p-tag"><b>INVOICE NO: </b><br>{{ $invoice->invoice_no }}</p>
                    </div>
                </th>
                <th class="bt" colspan="1" rowspan="2" style="text-align: center; border-right: 1px solid #000; border-bottom: 1px solid #000">
                    <div class="text-center">
                        <p class="p-tag"><b>INVOICE DATE: </b><br>{{ \Carbon\Carbon::parse($invoice->invoice_date)->format('d-m-Y') }}</p>
                    </div>
                </th>
            </tr>
            <tr>
                    ...
                    <div class="text-center" >
                        @if ($purchaseOrder)
                            ...
                            @if ($invoice->jmr_no != null)
                                <p class="p-tag"><b>JMR NO: </b><br>{{ $invoice->jmr_no }}</p>
                            @endif
                            @if ($invoice->capex_no != null)
                                <p class="p-tag"><b>Capex NO: </b><br>{{ $invoice->capex_no }}</p>
                            @endif
                        @endif
                    </div>
                </th>
